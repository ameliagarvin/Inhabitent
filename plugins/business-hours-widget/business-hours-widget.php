 ...
 * @author    Amelia <ameliagarvin1@.com>
 * @license   GPL-2.0+
 * @link      http://ameliagarvin.com
 * @copyright 2015 Your Name or Company Name
 *
 * @wordpress-plugin
 * Plugin Name:       Inhabitent business hours widget
 * Plugin URI:        @TODO
 * Description:       Inhabitent business hours widget code along
 * Version:           1.0.0
 * Author:            Amelia
 * Author URI:        ameliagarvin.com
 * License:           GPL-2.0+
...
class Tent_Biz_Hours extends WP_Widget {
	...
	public function __construct() {
		...
		// TODO: update description the double colon is a constant in php
		parent::__construct(
	...
	public function widget( $args, $instance ) {
		...
		// TODO: other fields go here...copy and paste above line below..changed title
	...
	//output buffer allows you to retrieve and store values in memory associated with short code
		ob_start();
